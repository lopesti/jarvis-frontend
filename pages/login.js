      ...
      <div style={{ 
        ...
        <div style={{ 
          ...
          <div style={{ textAlign: 'center', marginBottom: '32px' }}>
            ...
            <h2 style={{ fontSize: '28px', fontWeight: 'bold', color: '#0A192F' }}>Bem-vindo de volta</h2>
            <p style={{ color: '#4A5568', marginTop: '4px' }}>Faça login para acessar sua conta</p>
          </div>
          ...
          <div style={{ marginTop: '24px', textAlign: 'center' }}>
            <p style={{ color: '#4A5568', fontSize: '14px' }}>
              Não tem uma conta?{' '}
              <Link href='/register' style={{ color: '#0077B6', textDecoration: 'none', fontWeight: 'bold' }}>
                Criar conta
              </Link>
            </p>
          </div>
